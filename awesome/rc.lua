...
mytextclock = wibox.widget.textclock(" %a %b %d, %j %I:%M:%S%P ")
...
globalkeys = gears.table.join(
	...
	awful.key({ modkey }, "Up", function()
		...
		volume_widget:inc(5)
	end, { description = "Volume up", group = "settings" }),

	awful.key({ modkey }, "Down", function()
		awful.spawn("pamixer --decrease 5")
		volume_widget:dec(5)
	end, { description = "Volume down", group = "settings" }),

	awful.key({ modkey }, ".", function()
		volume_widget:toggle()
		-- awful.spawn("toggle-mute.sh")
	end, { description = "Mute", group = "settings" })
)
...
-- https://bbs.archlinux.org/viewtopic.php?id=168549
